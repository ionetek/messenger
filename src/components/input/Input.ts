...
export default class Input extends Block {
  render() {
    const className = this.props.label ?? '';
    ...
    const temp = `<div class="input-wrapper">
                            ...
                            <input type="<% this.type %>" name="<% this.name %>" 
                                class="input-wrapper__form-control input-wrapper__form-control-lg <% this.errors[this.name] ? ' input-wrapper__has-error' : '' %> ${className}"
